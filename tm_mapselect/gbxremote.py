...
class DedicatedRemote:
    ...
    def _attempt_connection(self):
        try:
            ...
            print(
                ...
                % (str(self.host), int(self.port), str(e))
            )
    ...
    def _result_loop(self):
        ...
        while True:
            ...
            try:
                ...
                try:
                    data, method = xmlrpc.client.loads(
                        packetdata, use_builtin_types=True
                    )
    ...
    def connect(self, maxretries=-1, attemptcb=None):
        ...
        while True:
            ...
            print(
                "TM2 Dedicated Server Connection Failed, re-try %d of %d ..."
                % (int(retries), int(maxretries))
            )
    ...
    def call(self, method, *args, retryConnection=True, asynchronous=False):
        ...
        try:
            ...
            with self.handlerslock:
                self.handlers[handler] = {"event": resultEvent, "result": None}
    ...
    def registerCallback(self, method, cb, obj=None, threadAsync=False):
        with self.callbacksLock:
            ...
            self.callbacks[method].append(
                {"async": threadAsync, "function": cb, "object": obj}
            )
